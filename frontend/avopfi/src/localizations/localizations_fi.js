let localizations_fi = {
  ...
  profiledata: {
    ...
    about: 'Palautekyselyyn välitetään taustatiedoiksi koulutus, ammattikorkeakoulu, koulutuksen kunta, tutkinnon suorituskieli. Henkilöön liittyviä tietoja ei välitetä palautekyselylle.',
