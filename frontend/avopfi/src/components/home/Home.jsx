          ...
          <div className="container">
             <div className="row">
              ...
              <div className="u-full-width">
                ...
                <p><Translate component="span" content="content.tulokset.results2"/>
                <a className="external" href="https://vipunen.fi/"><Translate component="span" content="content.tulokset.results_link"/></a>
                </p>
                </div>
            </div>
          </div>
